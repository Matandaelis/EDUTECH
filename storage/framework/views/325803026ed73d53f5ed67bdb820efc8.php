...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['blog', 'menu']));
...
foreach (array_filter((['blog', 'menu']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="flex flex-col overflow-hidden rounded-lg border border-gray-200 shadow-lg dark:border-gray-700">
    <div class="flex-shrink-0">
        <div class="relative">
            <a href="<?php echo e('/pages/b/' . $menu->slug . '/' . $blog->slug); ?>">
                <img class="lozad h-48 w-full object-cover" data-src="<?php echo e($blog->cover_image); ?>"
            ...
            <div class="flex justify-between">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->category): ?>
                    <p class="text-site-primary text-sm font-medium">
                        <a
                            href="<?php echo e(route('site.page.blog-list-category', ['slug' => $menu->slug, 'category' => $blog->category->slug])); ?>">
...
<?php endif; ?>
<?php $component->withAttributes(['color' => 'custom','color-value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($blog->category->color)]); ?><?php echo e($blog->category->name); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e('/pages/b/' . $menu->slug . '/' . $blog->slug); ?>" class="mt-2 block">
                <p class="text-xl font-semibold text-gray-900 dark:text-gray-300"><?php echo e($blog->title); ?></p>
                <p class="mt-3 text-base text-gray-500 dark:text-gray-400"><?php echo e(Str::summary($blog->sub_title)); ?></p>
            </a>
        </div>
            ...
            <div class="mt-2 flex flex-wrap gap-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $blog->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a class="truncate rounded-lg bg-gray-200 px-2 py-1 text-sm text-gray-800 dark:bg-gray-500 dark:text-gray-300"
                        href="<?php echo e(route('site.page.blog-list-tag', ['slug' => $menu->slug, 'tag' => strtolower($tag->name)])); ?>">#<?php echo e($tag->name); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
</div>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/components/site/default/blog-card.blade.php ENDPATH**/ ?>