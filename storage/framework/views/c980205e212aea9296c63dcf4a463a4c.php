<div class="sidebar no-print" :class="{ open: isSidebarOpen }">
    <div style="padding:20px 10px; color:#d1d5db;">
        ...
        <div class="mt-4">
            <div><?php echo e(trans('print.title')); ?></div>
            <div class="mt-1">
                <input type="text" v-model="title" />
            </div>
        </div>
        <div class="mt-4">
            <div><?php echo e(trans('print.sub_title')); ?></div>
            <div class="mt-1">
                <input type="text" v-model="subTitle" />
            </div>
        </div>
        <div class="mt-4">
            <div><?php echo e(trans('print.footer_note')); ?></div>
            <div class="mt-1">
                <textarea rows="5" v-model="footerNote"></textarea>
            </div>
        </div>
        <div class="mt-4">
            <div><?php echo e(trans('print.margin_top')); ?></div>
            <div class="mt-1">
        ...
        <div class="mt-4">
            <div style="display: flex; justify-content: space-between;">
                <?php echo e(trans('print.show_header')); ?>
        ...
        <div class="mt-4">
            <div style="display: flex; justify-content: space-between;">
                <?php echo e(trans('print.show_print_time')); ?>
...
<div :style="{ marginTop: `${marginTop}px` }">
    ...
    <div class="footer">
        ...
        <p class="timestamp" v-if="showPrintTime">
            <?php echo e(trans('print.printed_at', ['attribute' => Cal::dateTime(now())->formatted])); ?></p>
    </div>
</div>
...
<script>
    ...
    createApp({
        data() {
            return {
                isSidebarOpen: false,
                title: "<?php echo e(isset($meta) ? Arr::get($meta, 'title') : ''); ?>",
                subTitle: "<?php echo e(isset($meta) ? Arr::get($meta, 'sub_title') : ''); ?>",
                footerNote: "",
                showHeader: true,
                marginTop: 0,
                showPrintTime: true,
...
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/components/print/wrapper.blade.php ENDPATH**/ ?>