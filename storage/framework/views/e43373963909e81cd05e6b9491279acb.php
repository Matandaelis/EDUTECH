...
<?php $component->withAttributes([]); ?>
        <table class="mt-2" width="100%" border="0" cellspacing="4" cellpadding="0">
            <td colspan="2">
                <h2 class="heading text-center">
                    <?php echo e(trans('student.fee_refund.fee_refund')); ?>
        ...
        <table class="mt-2 table" width="100%" border="0" cellspacing="4" cellpadding="0">
            <thead>
                <tr>
                    <th><?php echo e(trans('finance.fee_head.fee_head')); ?></th>
                    <th class="text-right"><?php echo e(trans('student.fee_refund.props.amount')); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $feeRefund->records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($record->head->name); ?></td>
            ...
            <tfoot>
                <tr>
                    <th><?php echo e(trans('general.total')); ?>

                        <?php echo e(\App\Helpers\CurrencyConverter::toWord($feeRefund->total->value)); ?></th>
                    <th class="text-right">

                        <?php echo e($feeRefund->total->formatted); ?>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/student/fee-refund.blade.php ENDPATH**/ ?>