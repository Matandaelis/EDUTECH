    ...
    <div class="sm:ml-6">
        <div class="sm:border-l sm:border-gray-600 sm:pl-6">
            <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">
                <?php echo e(trans('general.errors.503_title')); ?></h1>
            <p class="mt-1 text-base text-gray-500"><?php echo e(trans('general.errors.503_description')); ?></p>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/errors/503.blade.php ENDPATH**/ ?>