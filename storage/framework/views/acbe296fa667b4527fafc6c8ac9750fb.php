...
<?php $component->withAttributes(['type' => 'full-page']); ?>
    ...
    <h2 class="heading"><?php echo e(trans('student.admission.admission')); ?></h2>

    <table width="100%">
        <tr>
            <td><img src="<?php echo e(Arr::get($student, 'contact.photo')); ?>" alt="Photo" width="100" height="auto">
            </td>
            <td class="text-right" valign="top" style="line-height: 1.5;">
                <strong><?php echo e(trans('student.admission.props.code_number')); ?>:
                    <?php echo e(Arr::get($student, 'admission.code_number')); ?></strong> <br />
                <strong><?php echo e(trans('student.admission.props.date')); ?>:
                    <?php echo e(Arr::get($student, 'admission.joining_date.formatted')); ?></strong> <br />
                <strong><?php echo e(trans('academic.period.period')); ?>:
                    <?php echo e(Arr::get($student, 'period.name')); ?></strong> <br />
                <strong><?php echo e(trans('academic.course.course')); ?>:
                    <?php echo e(Arr::get($student, 'batch.course.name')); ?> <?php echo e(Arr::get($student, 'batch.name')); ?></strong>
                <br />
                <strong><?php echo e(trans('student.enrollment_type.enrollment_type')); ?>:
                    <?php echo e(Arr::get($student, 'enrollment_type.name')); ?></strong>
        </tr>
    </table>
    ...
    <table class="mt-4 table" style="table-layout: fixed;">
        <tr>
            ...
            <td><?php echo e(Arr::get($student, 'contact.name')); ?></td>
            <th><?php echo e(trans('contact.props.contact_number')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.contact_number')); ?></td>
            <th><?php echo e(trans('contact.props.email')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.email')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.props.alternate_contact_number')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.alternate_records.contact_number')); ?>

            <th><?php echo e(trans('contact.props.alternate_email')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.alternate_records.email')); ?></td>
            </td>
            <th></th>
            <td></td>
        </tr>
        <tr>
            ...
            <td><?php echo e(Arr::get($student, 'contact.birth_date.formatted')); ?></td>
            <th><?php echo e(trans('contact.props.gender')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.gender.label')); ?></td>
            <th><?php echo e(trans('contact.props.locality')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.locality.label')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.category.category')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.category.name')); ?></td>
            <th><?php echo e(trans('contact.caste.caste')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.caste.name')); ?></td>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('config.student.enable_unique_id_fields')): ?>
            <tr>
                ...
                <td><?php echo e(Arr::get($student, 'contact.unique_id_number1')); ?></td>
                <th><?php echo e(config('config.student.unique_id_number2_label')); ?></th>
                <td><?php echo e(Arr::get($student, 'contact.unique_id_number2')); ?></td>
                <th><?php echo e(config('config.student.unique_id_number3_label')); ?></th>
                <td><?php echo e(Arr::get($student, 'contact.unique_id_number3')); ?></td>
            </tr>
            <tr>
                <th><?php echo e(config('config.student.unique_id_number4_label')); ?></th>
                <td><?php echo e(Arr::get($student, 'contact.unique_id_number4')); ?></td>
                <th><?php echo e(config('config.student.unique_id_number5_label')); ?></th>
                <td><?php echo e(Arr::get($student, 'contact.unique_id_number5')); ?></td>
                <th></th>
                <td></td>
            </tr>
        ...
        <tr>
            ...
            <td><?php echo e(Arr::get($student, 'contact.birth_place')); ?></td>
            <th><?php echo e(trans('contact.props.nationality')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.nationality')); ?></td>
            <th><?php echo e(trans('contact.props.mother_tongue')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.mother_tongue')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.props.blood_group')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.blood_group.label')); ?></td>
            <th><?php echo e(trans('contact.props.marital_status')); ?></th>
            <td><?php echo e(Arr::get($student, 'contact.marital_status.label')); ?></td>
            <th></th>
            <td></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.props.present_address')); ?></th>
            <td style="max-width: 20%;"><?php echo e(Arr::get($student, 'contact.present_address_display')); ?></td>
            <th><?php echo e(trans('contact.props.permanent_address')); ?></th>
            <td style="max-width: 20%;"><?php echo e(Arr::get($student, 'contact.permanent_address_display')); ?></td>
            <th></th>
            <td></td>
        </tr>
    </table>
    ...
    <table class="mt-4 table">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($student, 'contact.guardians', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guardian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    ...
    <table class="mt-4 table">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($student, 'contact.qualifications', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    ...
    <table class="mt-4 table">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($student, 'contact.documents', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td><?php echo e(Arr::get($document, 'title')); ?></td>
                <td><?php echo e(Arr::get($document, 'type.name')); ?></td>
                <td><?php echo e(Arr::get($document, 'period')); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </table>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/student/admission.blade.php ENDPATH**/ ?>