...
<?php $component->withAttributes(['type' => 'full-page']); ?>
    ...
    <h2 class="heading"><?php echo e(trans('global.report', ['attribute' => trans('student.attendance.attendance')])); ?></h2>

    <table width="100%">
        <tr>
            <td>Total Days: <?php echo e($totalDays); ?></td>
            <td class="text-center">Holidays: <?php echo e($holidayCount); ?></td>
            <td class="text-right">Working Days: <?php echo e($workingDays); ?></td>
        </tr>
    </table>
    ...
    <table border="1" class="border-dark mt-2 table" width="100%" border="0" cellspacing="4" cellpadding="0">
        <thead>
            ...
            <th><?php echo e(trans('global.count', ['attribute' => trans('student.attendance.attendance')])); ?></th>
        </thead>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><?php echo e(Arr::get($item, 'count', 0)); ?></td>
            </tr>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/reports/student/attendance.blade.php ENDPATH**/ ?>