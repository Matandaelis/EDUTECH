                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $studentPair; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div style="width: <?php echo e(Arr::get($layout, 'box_width')); ?>; border: 1px solid black;">
                        ...
                        <div class="<?php echo e(Arr::get($layout, 'watermark') ? 'watermark-container' : ''); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($overallResult): ?>
                                <table class="mt-4 inner-table cellpadding" width="100%">
                                    <tr>
                                        <th><?php echo e(trans('academic.subject.subject')); ?></th>
                                        <th><?php echo e(trans('exam.lowest_mark')); ?></th>
                                        <th><?php echo e(trans('exam.average_mark')); ?></th>
                                        <th><?php echo e(trans('exam.highest_mark')); ?></th>
                                        <th><?php echo e(trans('exam.highest_grade')); ?></th>
                                    </tr>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $overallResult; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e(Arr::get($result, 'code')); ?></td>
                                            <td><?php echo e(Arr::get($result, 'lowest_marks')); ?></td>
                                            <td><?php echo e(Arr::get($result, 'average_marks')); ?></td>
                                            <td><?php echo e(Arr::get($result, 'highest_marks')); ?></td>
                                            <td><?php echo e(Arr::get($result, 'highest_grade')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </table>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/exam/marksheet/cumulative.blade.php ENDPATH**/ ?>