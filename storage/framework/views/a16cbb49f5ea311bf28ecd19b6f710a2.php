...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($items)): ?>
    <div x-data="testimonialCarousel(<?php echo e(json_encode([
        'items' => $items,
        'autoplay' => $autoplay,
        'interval' => $interval,
        'loop' => $loop,
        ...
        class="<?php echo e($class); ?> relative mx-auto w-full max-w-6xl select-none focus:outline-none">
        ...
        <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 to-white shadow-xl">
                ...
                <template x-for="(item, index) in items" :key="index">
                    <div x-show="currentIndex === index" x-transition:enter="transition ease-out duration-500"
                        ...
                        <div class="flex h-full flex-col items-center justify-center p-8 text-center md:p-12">
                            ...
                            <!-- Rating (if enabled) -->
                            <div x-show="<?php echo e($showRating ? 'true' : 'false'); ?>" class="mb-6 flex items-center">
            ...
            <!-- Navigation Arrows -->
            <template x-if="<?php echo e($showNavigation ? 'true' : 'false'); ?>">
                <div>
                    <!-- Previous Button -->
        ...
        <!-- Dots Indicator -->
        <template x-if="<?php echo e($showDots ? 'true' : 'false'); ?>">
...
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/components/site/default/testimonial.blade.php ENDPATH**/ ?>