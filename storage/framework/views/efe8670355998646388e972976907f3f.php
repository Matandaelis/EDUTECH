...
[$__name, $__params] = $__split('query');

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1391729488-0', null);
...
?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('config.site.google_map_embed_url')): ?>
        <div class="lg:w-5/12 ms-auto overflow-x-hidden">
            <div class="h-[520px]">
                <div class="h-100">
                    <iframe class="w-full h-[500px]" src="<?php echo e(config('config.site.google_map_embed_url')); ?>"
...
<div class="mt-8 grid md:grid-cols-3 gap-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <a href="mailto:<?php echo e(config('config.general.app_email')); ?>"
                class="text-default-500 my-1"><?php echo e(config('config.general.app_email')); ?></a>
        </div>
    </div>
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <a href="tel:<?php echo e(config('config.general.app_phone')); ?>"
                class="text-default-500 my-1"><?php echo e(config('config.general.app_phone')); ?></a>
        </div>
    </div>
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <span
                class="flex-wrap"><?php echo e(collect([
...
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/components/site/default/contact.blade.php ENDPATH**/ ?>