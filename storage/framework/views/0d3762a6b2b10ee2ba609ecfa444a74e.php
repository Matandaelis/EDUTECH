...
<?php $component->withAttributes(['type' => 'centered']); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($data, 'feeGroups'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th><?php echo e(Arr::get($feeGroup, 'name')); ?></th>
                    <th></th>
                    <th></th>
                    <th><?php echo e(Arr::get($feeGroup, 'total')->formatted); ?></th>
                    <th><?php echo e(Arr::get($feeGroup, 'paid')->formatted); ?></th>
                    <th><?php echo e(Arr::get($feeGroup, 'balance')->formatted); ?></th>
                </tr>
            </thead>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/student/fee.blade.php ENDPATH**/ ?>