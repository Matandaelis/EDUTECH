                ...
                <div class="mx-auto max-w-max">
                    ...
                    <div class="mt-6 flex justify-center">
                        <a class="rounded bg-gray-800 px-4 py-2 text-gray-200"
                            href="<?php echo e(route('app')); ?>"><?php echo e(trans('dashboard.dashboard')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/components/layout.blade.php ENDPATH**/ ?>