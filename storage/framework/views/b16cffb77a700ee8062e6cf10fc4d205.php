...
<?php $component->withAttributes(['type' => 'full-page']); ?>
    ...
    <h2 class="heading"><?php echo e(trans('reception.enquiry.enquiry')); ?></h2>

    <table width="100%">
        <tr>
            <td><img src="<?php echo e(Arr::get($enquiry, 'contact.photo')); ?>" alt="Photo" width="100" height="auto">
            </td>
            <td class="text-right" valign="top" style="line-height: 1.5;">
                <strong><?php echo e(trans('reception.enquiry.props.code_number')); ?>:
                    <?php echo e(Arr::get($enquiry, 'code_number')); ?></strong> <br />
                <strong><?php echo e(trans('reception.enquiry.props.date')); ?>:
                    <?php echo e(Arr::get($enquiry, 'date.formatted')); ?></strong> <br />
                <strong><?php echo e(trans('academic.period.period')); ?>:
                    <?php echo e(Arr::get($enquiry, 'period.name')); ?></strong> <br />
                <strong><?php echo e(trans('academic.course.course')); ?>:
                    <?php echo e(Arr::get($enquiry, 'course.name')); ?></strong> <br />
                <strong><?php echo e(trans('reception.enquiry.props.assigned_to')); ?>:
                    <?php echo e(Arr::get($enquiry, 'employee.name')); ?></strong>
        </tr>
    </table>

    <table class="mt-4 table" style="table-layout: fixed;">
        <tr>
            <th><?php echo e(trans('reception.enquiry.props.stage')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'stage.name')); ?></td>
            <th><?php echo e(trans('reception.enquiry.props.type')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'type.name')); ?></td>
            <th><?php echo e(trans('reception.enquiry.props.source')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'source.name')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.props.name')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.name')); ?></td>
            <th><?php echo e(trans('contact.props.contact_number')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.contact_number')); ?></td>
            <th><?php echo e(trans('contact.props.email')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.email')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.props.alternate_contact_number')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.alternate_records.contact_number')); ?>

            <th><?php echo e(trans('contact.props.alternate_email')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.alternate_records.email')); ?></td>
            </td>
            <th></th>
            <td></td>
        </tr>
        <tr>
            ...
            <td><?php echo e(Arr::get($enquiry, 'contact.birth_date.formatted')); ?></td>
            <th><?php echo e(trans('contact.props.gender')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.gender.label')); ?></td>
            <th><?php echo e(trans('contact.props.locality')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.locality.label')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.category.category')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.category.name')); ?></td>
            <th><?php echo e(trans('contact.caste.caste')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.caste.name')); ?></td>
            <th><?php echo e(trans('contact.religion.religion')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.caste.name')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(config('config.student.unique_id_number1_label')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.unique_id_number1')); ?></td>
            <th><?php echo e(config('config.student.unique_id_number2_label')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.unique_id_number2')); ?></td>
            <th><?php echo e(config('config.student.unique_id_number3_label')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.unique_id_number3')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(config('config.student.unique_id_number4_label')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.unique_id_number4')); ?></td>
            <th><?php echo e(config('config.student.unique_id_number5_label')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.unique_id_number5')); ?></td>
            <th></th>
            <td></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.props.birth_place')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.birth_place')); ?></td>
            <th><?php echo e(trans('contact.props.nationality')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.nationality')); ?></td>
            <th><?php echo e(trans('contact.props.mother_tongue')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.mother_tongue')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('contact.props.blood_group')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.blood_group.label')); ?></td>
            <th><?php echo e(trans('contact.props.marital_status')); ?></th>
            <td><?php echo e(Arr::get($enquiry, 'contact.marital_status.label')); ?></td>
            <th>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($enquiry, 'custom_fields', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr>
            ...
            <td style="width: 20%;"><?php echo e(Arr::get($enquiry, 'contact.present_address_display')); ?></td>
            <th><?php echo e(trans('contact.props.permanent_address')); ?></th>
            <td style="width: 20%;"><?php echo e(Arr::get($enquiry, 'contact.permanent_address_display')); ?></td>
            <th></th>
            <td></td>
        </tr>
    </table>
    ...
    <table class="mt-4 table">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($enquiry, 'contact.guardians', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guardian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    ...
    <table class="mt-4 table">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($enquiry, 'contact.documents', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
    ...
    <table class="mt-4 table">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($enquiry, 'contact.qualifications', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/reception/enquiry.blade.php ENDPATH**/ ?>