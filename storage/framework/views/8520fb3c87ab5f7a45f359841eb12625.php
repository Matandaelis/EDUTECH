                    ...
                    <div style="width: <?php echo e(Arr::get($layout, 'box_width')); ?>; border: 1px solid black;">
                        ...
                        <div class="<?php echo e(Arr::get($layout, 'watermark') ? 'watermark-container' : ''); ?>">
                            ...
                            <table class="mt-2 inner-table cellpadding" width="100%">
                                ...
                                <tr>
                                    <td><?php echo e(trans('academic.course.props.term')); ?></td>
                                    <td class="text-right"><?php echo e($student->course_term); ?>

                                    </td>
                                    <td><?php echo e(trans('student.enrollment_type.enrollment_type')); ?></td>
                                    <td class="text-right"><?php echo e($student->enrollment_type_name); ?></td>
                                </tr>
                            </table>
                                    ...
                                    <tr>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td colspan="<?php echo e(Arr::get($cell, 'colspan', 1)); ?>"
                                                ...
                                                ]); ?>" style=<?php echo e(Arr::get($cell, 'style')); ?>
                            ...
                            <table class="mt-4 inner-table font-85pc" width="100%">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $student->summaryRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <td colspan="<?php echo e(Arr::get($cell, 'colspan', 1)); ?>"
                                                class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            ...
                            <p class="ml-4"><?php echo e(trans('exam.result_date')); ?>:
                                <?php echo e(\Cal::date(Arr::get($params, 'result_date'))->formatted); ?></p>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/exam/exam-wise-credit-based-marksheet.blade.php ENDPATH**/ ?>