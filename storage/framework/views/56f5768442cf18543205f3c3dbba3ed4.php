...
<?php $component->withAttributes(['type' => 'centered']); ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $parents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div>
            <h1 class="font-110pc font-weight-bold"><?php echo e($loop->iteration); ?>. <?php echo e($parent->father_name); ?> &
                <?php echo e($parent->mother_name); ?></h1>

            <table class="table" width="100%">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $parent->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td width="40%"><?php echo e($student->name); ?></td>
                        <td width="10%"><?php echo e($student->admission_number); ?></td>
                        <td width="20%"><?php echo e($student->course_name . ' ' . $student->batch_name); ?></td>
                        <td width="30%"><?php echo e($student->fee_concession); ?></td>
                    </tr>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/student/siblings.blade.php ENDPATH**/ ?>