        ...
        <div class="mb-8">
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex space-x-8 overflow-x-auto">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $programTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schoolName => $schoolData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button @click="activeSchool = '<?php echo e($schoolName); ?>', activeType = 0"
                            :class="activeSchool === '<?php echo e($schoolName); ?>' ?
...
<script>
    function programsData() {
        return {
            activeSchool: '<?php echo e(array_key_first($programTypes)); ?>', // Initialize with first school
            activeType: 0,
            schoolsData: <?php echo json_encode($programTypes, 15, 512) ?>,
...
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/components/site/default/program-detail.blade.php ENDPATH**/ ?>