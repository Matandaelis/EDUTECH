...
<?php $component->withAttributes(['type' => 'full-page']); ?>
    ...
    <div class="<?php echo e(Arr::get($layout, 'watermark') ? 'watermark-container' : ''); ?>">
        ...
        <?php echo $__env->first([config('config.print.custom_path') . 'exam.report.header', 'print.exam.report.header'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <td colspan="2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $titles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Arr::get($title, 'label')): ?>
                            <div class="<?php echo e(Arr::get($title, 'class')); ?>"><?php echo e(Arr::get($title, 'label')); ?></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <table border="1" class="border-dark mt-2 table" width="100%" border="0" cellspacing="4"
            ...
            <tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $header; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td class="<?php echo e(Arr::get($item, 'class')); ?>" rowspan="<?php echo e(Arr::get($item, 'rowspan', 1)); ?>"
                        colspan="<?php echo e(Arr::get($item, 'colspan', 1)); ?>"
                        <?php if(Arr::get($item, 'height')): ?> height="<?php echo e(Arr::get($item, 'height')); ?>px" <?php endif; ?>>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty(Arr::get($item, 'span-style'))): ?>
                            <span class="<?php echo e(Arr::get($item, 'span-style')); ?>"><?php echo e(Arr::get($item, 'label')); ?></span>
                        <?php else: ?>
            ...
            <tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subHeader; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td class="<?php echo e(Arr::get($item, 'class')); ?>" rowspan="<?php echo e(Arr::get($item, 'rowspan', 1)); ?>"
                        colspan="<?php echo e(Arr::get($item, 'colspan', 1)); ?>"
                        <?php if(Arr::get($item, 'height')): ?> height="<?php echo e(Arr::get($item, 'height')); ?>px" <?php endif; ?>>
                        <?php echo e(Arr::get($item, 'label')); ?>
                ...
                <tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td class="<?php echo e(Arr::get($item, 'class')); ?>" rowspan="<?php echo e(Arr::get($item, 'rowspan', 1)); ?>"
                            colspan="<?php echo e(Arr::get($item, 'colspan', 1)); ?>"
                            <?php if(Arr::get($item, 'height')): ?> height="<?php echo e(Arr::get($item, 'height')); ?>px" <?php endif; ?>>
                            <span class="<?php echo e(Arr::get($item, 'text-style')); ?>"><?php echo e(Arr::get($item, 'label')); ?></span>
                        </td>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php echo $__env->first(['print.exam.signatory'], ['layout' => $layout], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/exam/report/mark-summary.blade.php ENDPATH**/ ?>