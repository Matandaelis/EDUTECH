...
<?php $component->withAttributes(['type' => 'centered']); ?>
    ...
    <h2 class="heading"><?php echo e(Arr::get($transaction, 'type.label')); ?></h2>

    <table width="100%">
        <tr>
            <td><strong><?php echo e(trans('finance.transaction.props.code_number_short')); ?>

                    <?php echo e(Arr::get($transaction, 'code_number')); ?></strong></td>
            <td class="text-right"><strong><?php echo e(trans('finance.transaction.props.date')); ?>

                    <?php echo e(Arr::get($transaction, 'date.formatted')); ?></strong></td>
        </tr>
    </table>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Arr::get($transaction, 'cancelled_at.value') && Arr::get($transaction, 'cancellation_remarks')): ?>
        <div class="mt-4">
            <p style="color: red;"><?php echo e(trans('finance.transaction.props.cancellation_remarks')); ?>:
                <?php echo e(Arr::get($transaction, 'cancellation_remarks')); ?></p>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Arr::get($transaction, 'rejected_at.value') && Arr::get($transaction, 'rejection_remarks')): ?>
        <div class="mt-4">
            <p style="color: red;"><?php echo e(trans('finance.transaction.props.rejection_remarks')); ?>:
                <?php echo e(Arr::get($transaction, 'rejection_remarks')); ?></p>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <table class="mt-4 table" style="table-layout: fixed;">
        <tr>
            <th style="width:25%;"><?php echo e(Arr::get($transaction, 'sub_heading')); ?></th>
            <td>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Arr::get($transaction, 'head')): ?>
                    <?php echo e(Arr::get($transaction, 'head')); ?>

                <?php else: ?>
                    <?php echo e(Arr::get($transaction, 'category.name')); ?>
        ...
        <tr>
            ...
            <td>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Arr::get($transaction, 'head')): ?>
                    <?php echo e(Arr::get($transaction, 'transactionable.name')); ?> </br>
                    <span class="font-90pc"><?php echo e(Arr::get($transaction, 'transactionable.contact')); ?></span>
                <?php else: ?>
                    <?php echo e(Arr::get($transaction, 'record.ledger.name')); ?>
        ...
        <tr>
            ...
            <td><?php echo e(Arr::get($transaction, 'amount.formatted')); ?>

                <?php echo e(App\Helpers\CurrencyConverter::toWord(Arr::get($transaction, 'amount.value'))); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('finance.transaction.props.description')); ?></th>
            <td><?php echo e(Arr::get($transaction, 'description') ?? Arr::get($transaction, 'remarks')); ?></td>
        </tr>
        <tr>
            <th><?php echo e(trans('finance.payment_method.payment_method')); ?></th>
            <td>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Arr::get($transaction, 'payments', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
    ...
    <div class="mt-4">
        <p class="font-80pc"><?php echo e(trans('user.user')); ?>: <?php echo e(Arr::get($transaction, 'user.profile.name')); ?></p>
    </div>
    <div class="mt-8">
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/finance/transaction.blade.php ENDPATH**/ ?>