...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($images)): ?>
    <div x-data="imageGallery(<?php echo e(json_encode([
        'images' => $images,
        'enableZoom' => $enableZoom,
        'autoplay' => $autoplay,
        'autoplayInterval' => $autoplayInterval,
    ])); ?>)" x-init="init()" class="<?php echo e($class); ?> w-full">
        <!-- Thumbnail Grid -->
        <div class="<?php echo e($gridCols[$columns] ?? $gridCols[4]); ?> <?php echo e($gapClasses[$gap] ?? $gapClasses[4]); ?> grid">
            <template x-for="(image, index) in images" :key="index">
                <div @click="openLightbox(index)"
                    class="<?php echo e($aspectClasses[$aspectRatio] ?? $aspectClasses['square']); ?> group relative cursor-pointer overflow-hidden rounded-lg transition-all duration-300 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:scale-[1.02] hover:shadow-lg"
                    ...
                    <!-- Caption (if enabled) -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showCaptions): ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/components/ui/image-gallery.blade.php ENDPATH**/ ?>