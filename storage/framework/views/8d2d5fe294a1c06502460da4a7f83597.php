...
<?php $component->withAttributes(['type' => 'centered']); ?>
    ...
    <div class="watermark-container">
        ...
        <table class="mt-8 table" width="100%">
            <thead>
                <tr>
                    <th colspan="2" class="text-center"><?php echo e(trans('employee.payroll.pay_head.categories.earning')); ?>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-right"><?php echo e(\Price::from($payroll->getMeta('actual.earning'))?->formatted); ?></td>
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan=4><?php echo e(App\Helpers\CurrencyConverter::toWord($payroll->total->value)); ?></td>
                </tr>
            </tfoot>
        </table>
        ...
        <table class="mt-4 table" width="100%">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attendanceSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($account)): ?>
            <div class="mt-4">
                <p><span><?php echo e(trans('finance.account.props.name')); ?>:</span> <?php echo e($account->name); ?></p>
                <p><span><?php echo e(trans('finance.account.props.number')); ?>:</span> <?php echo e($account->number); ?></p>
                <p><span><?php echo e(trans('finance.account.props.bank_name')); ?>:</span>
                    <?php echo e(Arr::get($account->bank_details, 'bank_name')); ?></p>
                <p><span><?php echo e(trans('finance.account.props.branch_name')); ?>:</span>
                    <?php echo e(Arr::get($account->bank_details, 'bank_branch')); ?>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/employee/payroll/salary-slip.blade.php ENDPATH**/ ?>