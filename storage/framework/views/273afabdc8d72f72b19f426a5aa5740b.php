        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('exam.result')); ?></th>
                    <th><?php echo e(trans('exam.marksheet.obtained_credit')); ?></th>
                    <th><?php echo e(trans('exam.gpa')); ?></th>
                </tr>
            </thead>
            <tbody>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e(Arr::get($student->summary, 'result')); ?></td>
                        <td><?php echo e(Arr::get($student->summary, 'total_obtained_credit')); ?></td>
                        <td><?php echo e(Arr::get($student->summary, 'gpa')); ?></td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </tbody>
        </table>
...
<?php endif; ?>
<?php /**PATH /home/rancorefrigerati/cloud2.rancorefrigeration.com/resources/views/print/exam/credit-based-summary-report.blade.php ENDPATH**/ ?>